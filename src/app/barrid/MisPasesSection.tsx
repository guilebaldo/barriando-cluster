...
export default function MisPasesSection({ tickets }: { tickets: AccessTicketCard[] }) {
  if (tickets.length === 0) return null;

  return (
    <section className="mt-5 space-y-3">
      <p className="text-[11px] font-bold uppercase tracking-widest text-amber-300 inline-flex items-center gap-1.5">
...
function TicketQrCard({ ticket }: { ticket: AccessTicketCard }) {
  ...
  return (
    <div className="rounded-2xl border border-white/15 bg-white p-4 text-center">
      <p className="text-sm font-semibold text-[#27366D] leading-snug">{ticket.event.title}</p>
