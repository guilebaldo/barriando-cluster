...
const TETRA_HELICE = [
  { icon: Building2, label: "Sector privado" },
  { icon: Landmark, label: "Gobierno" },
  { icon: GraduationCap, label: "Academia" },
  { icon: HeartHandshake, label: "Sociedad civil" },
] as const;
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased">
      ...
      <section className="bg-[#27366D] py-12 md:py-16 px-6 text-center border-b border-[#1e2b58]">
        <Image
          ...
          width={320}
          height={120}
          className="mx-auto w-44 md:w-56 lg:w-64 h-auto opacity-90"
          priority
        />
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        <header className="text-center mb-10 md:mb-14">
          <p className="text-xs font-bold uppercase tracking-widest text-[#27366D]">Barriando Clúster</p>
        ...
        <div className="max-w-3xl mx-auto">
          <section className="border-b border-gray-100 py-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              {TETRA_HELICE.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex flex-col items-center text-center gap-2 rounded-xl border border-slate-100 bg-slate-50 px-3 py-4"
                >
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#27366D]/10 text-[#27366D]">
          ...
          <section className="border-b border-gray-100 py-8">
            ...
            <span className="text-xs text-gray-400 mt-2 block">
              Referencia Académica (Estilo APA):
              <br />
