...
export default function MapImmersiveShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="map-immersive-shell relative z-0 flex flex-col h-[100dvh] max-h-[100dvh] bg-white text-slate-900 font-sans antialiased overflow-hidden overscroll-none">
      {children}
    </div>
  );
}
