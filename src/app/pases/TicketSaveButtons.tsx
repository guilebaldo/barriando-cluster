...
export default function TicketSaveButtons({ ticket }: { ticket: AccessTicketCard }) {
  ...
  return (
    <button
      ...
      className="inline-flex w-full items-center justify-center gap-1.5 border border-slate-200 bg-white text-[#27366D] hover:bg-slate-50 font-bold text-[11px] uppercase tracking-wider px-3 py-2.5 rounded-xl transition"
    >
