      ...
      <main className="max-w-md mx-auto py-16 px-6">
        <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
          ...
          <p className="text-xs text-slate-500 mb-6 font-light flex items-start gap-2">
            ...
            Regístrate gratis como <strong className="text-slate-700">Vecino</strong> para recibir noticias, eventos e invitaciones del Clúster.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? "Registrando..." : "Crear cuenta — plan Vecino gratis"}
            </button>
          </form>
