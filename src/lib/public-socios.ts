...
/**
 * Negocios con membresía comercial activa (pago $ / manual_active).
 * Tras pagar deben aparecer en /socios y pasaporte sin esperar aprobación editorial;
 * solo se excluyen perfiles rechazados o sin nombre.
 */
